...
/** https://www.youtube.com/watch?v=ZBHKZF5w4YU https://youtu.be/ZBHKZF5w4YU?t=950 is the code for creation and https://youtu.be/ZBHKZF5w4YU?t=1431 for query
...
int constructSegmentTree( int[] segArr, int start, int end, int pos ){
    ...
    //will be computed again for min query, sum query or update query as start and end parameters
...
public static void main(String[] args) {
    int[] heights=new int[]{5, 3, 2, 6, 1, 4};
    int[] inFront=new int[]{0, 1, 2, 0, 3, 2};
